...
$headerContent = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
						<html lang="en">
							<head>
								...
								<body style="margin:0; padding:0; background-color:#FAFAFA;font-family:FreeSans;">
...
{
	$footerContent .= '<td width="300" align="left" style="padding:0px;font-weight: 600;">'.$cf7_opt_footer_text.'</td>';
}
else
{
	$footerContent .= '<td width="300" align="left" style="padding:0px;font-weight: 600;">Copyright © '.date('Y').' <a href="'.site_url().'" target="_blank">'.get_bloginfo( 'name' ).'</a></td>';	
}
